...
output "message_distribution_id" {
  description = "Message CloudFront distribution ID"
  value       = aws_cloudfront_distribution.message.id
}

output "message_distribution_domain_name" {
  description = "Message CloudFront distribution domain name (for DNS CNAME)"
